...
class Query_Req final :
 ...
 public:
  ...
  inline Query_Req(const Query_Req& from)
      : Query_Req(nullptr, from) {}
  ...
  Query_Req(::google::protobuf::Arena* arena, const Query_Req& from);
  public:
...
class Delete_Req final :
 ...
 public:
  ...
  inline Delete_Req(const Delete_Req& from)
      : Delete_Req(nullptr, from) {}
  ...
  Delete_Req(::google::protobuf::Arena* arena, const Delete_Req& from);
  public:
...
class Add_Req final :
 ...
 public:
  ...
  inline Add_Req(const Add_Req& from)
      : Add_Req(nullptr, from) {}
  ...
  void set_allocated_kv_json(std::string* value);
...
inline PROTOBUF_ALWAYS_INLINE void Add_Req::set_kv_json(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.kv_json_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:kv_operate.Add_Req.kv_json)
}
inline std::string* Add_Req::mutable_kv_json() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Add_Req::_internal_set_kv_json(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.kv_json_.Set(value, GetArena());
}
inline std::string* Add_Req::_internal_mutable_kv_json() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.kv_json_.Mutable( GetArena());
}
...
inline void Add_Req::set_allocated_kv_json(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.kv_json_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.kv_json_.IsDefault()) {
          _impl_.kv_json_.Set("", GetArena());
        }
...
inline std::string* Delete_Req::mutable_key() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* Query_Req::mutable_key() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_key();
...
inline std::string* Reply::mutable_res() ABSL_ATTRIBUTE_LIFETIME_BOUND {
